...
const mockServices = [
    ...
    { _id: '12', title: 'Медицинская экспертиза', shortDescription: 'Оценка состояния здоровья и причин повреждений', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=400&h=300&fit=crop' },
    { _id: '13', title: 'Товароведческая экспертиза', shortDescription: 'Анализ качества товаров и их соответствия стандартам', image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=300&fit=crop' },
